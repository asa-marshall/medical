...
angular.module('medical.substanceAbuse')
    .component( "substanceAbuse",
        {
            templateUrl: "medical-substance-abuse/substance-abuse.view.html",
            ...
            controller: ['$scope', '$http', '$rootScope',
                function SubstanceAbuseController($scope, $http, $rootScope) {
                    ...
                    this.ID_Field = "MedSubstAbuseID";
                    this.phpURL_get="./php/medical_getSubstanceAbuse.php";
                    this.phpURL_create="./php/medical_createSubstanceAbuse.php";
                    this.phpURL_delete="./php/medical_deleteSubstanceAbuse.php";
                    this.phpURL_update="./php/medical_updateSubstanceAbuse.php";
